...
import (
	...
	"github.com/vk-cs/iot-go-agent-sdk/gen/swagger/http_client/client/devices"
	"github.com/vk-cs/iot-go-agent-sdk/gen/swagger/http_client/client/events"
	"github.com/vk-cs/iot-go-agent-sdk/gen/swagger/http_client/client/logs"
	"github.com/vk-cs/iot-go-agent-sdk/gen/swagger/http_client/client/swagger"
)

// Default HTTP HTTP client.
...
// NewHTTPClient creates a new HTTP HTTP client.
func NewHTTPClient(formats strfmt.Registry) *HTTP {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new HTTP HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *HTTP {
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *HTTP {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *HTTP) SetTransport(transport runtime.ClientTransport) {
